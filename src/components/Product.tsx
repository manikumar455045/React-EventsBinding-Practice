                ...
                <section>
                    ...
                    <table className="table table-hover text-center text-white table-striped">
                        ...
                        <tr>
                            ...
                            <td><img src={this.state.product.img}  width="50px" className="img-fluid" alt=""/></td>
                            <td><i className="fa fa-minus-circle" onClick={this.incQty.bind(this, "dec")}/> {this.state.product.qty} <i className="fa fa-plus-circle" onClick={this.incQty.bind(this, "inc")}/></td>
